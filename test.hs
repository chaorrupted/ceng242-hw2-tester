...
eagerEvalIn = [
               ...
               {- Hierarchy 3 -}(ASTNode (ASTLetDatum "x") (ASTNode (ASTSimpleDatum "plus") (ASTNode (ASTSimpleDatum "num") (ASTNode (ASTSimpleDatum "27") EmptyAST EmptyAST) EmptyAST) (ASTNode (ASTSimpleDatum "times") (ASTNode (ASTSimpleDatum "num") (ASTNode (ASTSimpleDatum "123") EmptyAST EmptyAST) EmptyAST) (ASTNode (ASTSimpleDatum "num") (ASTNode (ASTSimpleDatum "25") EmptyAST EmptyAST) EmptyAST))) (ASTNode (ASTSimpleDatum "plus") (ASTNode (ASTSimpleDatum "len") (ASTNode (ASTSimpleDatum "cat") (ASTNode (ASTSimpleDatum "str") (ASTNode (ASTSimpleDatum "10") EmptyAST EmptyAST) EmptyAST) (ASTNode (ASTSimpleDatum "str") (ASTNode (ASTSimpleDatum "6") EmptyAST EmptyAST) EmptyAST)) EmptyAST) (ASTNode (ASTSimpleDatum "x") EmptyAST EmptyAST)))
               ]
eagerEvalOut = [
                (ASTJust ("14","num",2)),
                (ASTJust ("8","num",2)),
...
funErrIn = [
            ...
            {- Hierarchy 1 -}(ASTNode (ASTLetDatum "x") (ASTNode (ASTSimpleDatum "plus") (ASTNode (ASTSimpleDatum "num") (ASTNode (ASTSimpleDatum "27") EmptyAST EmptyAST) EmptyAST) (ASTNode (ASTSimpleDatum "times") (ASTNode (ASTSimpleDatum "str") (ASTNode (ASTSimpleDatum "123") EmptyAST EmptyAST) EmptyAST) (ASTNode (ASTSimpleDatum "num") (ASTNode (ASTSimpleDatum "plot") EmptyAST EmptyAST) EmptyAST))) (ASTNode (ASTSimpleDatum "x") EmptyAST EmptyAST)),
            {- Hierarchy 2 -}(ASTNode (ASTLetDatum "x") (ASTNode (ASTSimpleDatum "plus") (ASTNode (ASTSimpleDatum "num") (ASTNode (ASTSimpleDatum "27") EmptyAST EmptyAST) EmptyAST) (ASTNode (ASTSimpleDatum "times") (ASTNode (ASTSimpleDatum "num") (ASTNode (ASTSimpleDatum "123") EmptyAST EmptyAST) EmptyAST) (ASTNode (ASTSimpleDatum "num") (ASTNode (ASTSimpleDatum "25") EmptyAST EmptyAST) EmptyAST))) (ASTNode (ASTSimpleDatum "plus") (ASTNode (ASTSimpleDatum "cat") (ASTNode (ASTSimpleDatum "str") (ASTNode (ASTSimpleDatum "10") EmptyAST EmptyAST) EmptyAST) (ASTNode (ASTSimpleDatum "x") EmptyAST EmptyAST)) (ASTNode (ASTSimpleDatum "num") (ASTNode (ASTSimpleDatum "3") EmptyAST EmptyAST) EmptyAST)))]
...
funErrOut = [
             ...
             (ASTError "the value 'plot' is not a number!"),
             (ASTError "cat operation is not defined between str and num!")
             ]
